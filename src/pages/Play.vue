...
<template>
  ...
  <div class="container">
    <Task :tasks="show_messages"></Task>
    <div class="typing_container">
      <!-- <div class="_container_uexsu_1" data-is-mobile=""><button class="_toNewMessageButton_uexsu_61"> 最新メッセージ<svg
            width="24" height="24" viewBox="0 0 24 24" role="img" class="_icon_w3eq5_1">
            <path d="M11,4H13V16L18.5,10.5L19.92,11.92L12,19.84L4.08,11.92L5.5,10.5L11,16V4Z" fill="currentColor">
            </path>
          </svg></button>
      <div class="_inputContainer_uexsu_23">
        <div class="_container_xt0gc_1 _leftControls_uexsu_50" data-is-mobile=""><button
        class="_container_155zf_1 _button_xt0gc_6" aria-disabled="false"><svg width="24" height="24" viewBox="0 0 24 24"
          class="_icon_155zf_5 _icon_w3eq5_1 _icon_155zf_5" role="img">
          <path d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" fill="currentColor"></path>
        </svg></button>
    </div>
    <div class="_container_1g6ht_1">
      <div
        style="position: absolute; overflow: auto; overflow-wrap: break-word; top: 0px; left: -9999px; white-space: pre-wrap; box-sizing: border-box; font-family: Inter, &quot;M PLUS 1p&quot;, Avenir, &quot;Helvetica Neue&quot;, Helvetica, Arial, &quot;Hiragino Sans&quot;, ヒラギノ角ゴシック, YuGothic, &quot;Yu Gothic&quot;, メイリオ, Meiryo, &quot;ＭＳ Ｐゴシック&quot;, &quot;MS PGothic&quot;, sans-serif; font-size: 16px; font-style: normal; font-variant: normal; font-weight: 400; height: 40px; letter-spacing: normal; line-height: 24px; max-height: 160px; min-height: auto; padding: 8px 75px 8px 16px; border-width: 0px; border-style: none; border-color: rgb(255, 255, 255); text-decoration: none solid rgb(255, 255, 255); text-indent: 0px; text-transform: none; word-spacing: 0px; width: 100%;">
        <span style="position: absolute;">&nbsp;</span>
      </div><textarea class="_textarea_ypp5f_1 _textarea_1g6ht_13" placeholder="メッセージを入力" rows="1"
        data-simple-padding="false" data-shrink-to-one-line="false" data-is-mobile="true" data-is-firefox="false"
        data-testid="message-input-textarea"
        style="--input-scrollbar-width: 11px; overflow: scroll; overflow-wrap: break-word; height: 160px;"></textarea>
      <div class="_over_1g6ht_43"></div>
    </div>
    <div class="_container_8c1wc_1 _rightControls_uexsu_54" data-is-mobile=""><button
        class="_container_155zf_1 _container_qeebw_1" title="スタンプを挿入" aria-disabled="false"><svg width="24" height="24"
          viewBox="0 0 24 24" class="_icon_155zf_5 _icon_w3eq5_1 _icon_155zf_5" role="img">
          <path
        ...
        </svg></button><button class="_sendButton_8c1wc_6" title="送信する" disabled=""
        data-testid="message-send-button"><svg width="24" height="24" viewBox="0 0 24 24" role="img"
          class="_icon_w3eq5_1">
      ...
      <p>
        ...
        <span class="test">{{ typing_state.seq_candidate }}</span>
      </p>
      <p>
        <span class="done">{{ typing_state.key_done }}</span>
        <span class="test">{{ typing_state.key_candidate }}</span>
      </p>
    </div>
  </div>
</template>
